namespace Practice_5_2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.radioButton_Underline = new System.Windows.Forms.RadioButton();
			this.tabPage_sentences = new System.Windows.Forms.TabPage();
			this.tableLayoutPanel_sentence = new System.Windows.Forms.TableLayoutPanel();
			this.radioButton_want_some = new System.Windows.Forms.RadioButton();
			this.radioButton_mom = new System.Windows.Forms.RadioButton();
			this.radioButton_the_moment = new System.Windows.Forms.RadioButton();
			...
			this.tabPage_font_style.SuspendLayout();
			this.tableLayoutPanel3.SuspendLayout();
			this.tabPage_sentences.SuspendLayout();
			this.tableLayoutPanel_sentence.SuspendLayout();
			...
			this.tabPage_image.Margin = new System.Windows.Forms.Padding(4);
			this.tabPage_image.Name = "tabPage_image";
			this.tabPage_image.Padding = new System.Windows.Forms.Padding(4);
			...
			this.tableLayoutPanel_img.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_just_do_it.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_doge.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_evil_patrick.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_excuse_me.Margin = new System.Windows.Forms.Padding(4);
			...
			this.tabPage_font_style.Margin = new System.Windows.Forms.Padding(4);
			this.tabPage_font_style.Name = "tabPage_font_style";
			this.tabPage_font_style.Padding = new System.Windows.Forms.Padding(4);
			...
			this.button_size_down.Margin = new System.Windows.Forms.Padding(4);
			...
			this.button_size_down.Click += new System.EventHandler(this.button_size_down_Click);
			// 
			// button_size_up
			// 
			...
			this.button_size_up.Margin = new System.Windows.Forms.Padding(4);
			...
			this.button_size_up.Click += new System.EventHandler(this.button_size_up_Click);
			// 
			// tableLayoutPanel3
			// 
			...
			this.tableLayoutPanel3.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.tableLayoutPanel3.Controls.Add(this.radioButton_Bold, 0, 0);
			...
			this.radioButton_Bold.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_Bold.CheckedChanged += new System.EventHandler(this.radioButton_Bold_CheckedChanged);
			// 
			// radioButton_Italic
			// 
			...
			this.radioButton_Italic.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_Italic.CheckedChanged += new System.EventHandler(this.radioButton_Italic_CheckedChanged);
			// 
			// radioButton_Regular
			// 
			...
			this.radioButton_Regular.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_Regular.CheckedChanged += new System.EventHandler(this.radioButton_Regular_CheckedChanged);
			// 
			// radioButton_Underline
			// 
			...
			this.radioButton_Underline.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_Underline.UseVisualStyleBackColor = true;
			this.radioButton_Underline.CheckedChanged += new System.EventHandler(this.radioButton_Underline_CheckedChanged);
			// 
			// tabPage_sentences
			// 
			...
			this.tabPage_sentences.Margin = new System.Windows.Forms.Padding(4);
			this.tabPage_sentences.Name = "tabPage_sentences";
			this.tabPage_sentences.Padding = new System.Windows.Forms.Padding(4);
			...
			this.tableLayoutPanel_sentence.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_want_some.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_want_some.UseVisualStyleBackColor = true;
			// 
			// radioButton_mom
			// 
			...
			this.radioButton_mom.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_mom.UseVisualStyleBackColor = true;
			// 
			// radioButton_the_moment
			// 
			...
			this.radioButton_the_moment.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioButton_the_moment.UseVisualStyleBackColor = true;
			// 
			...
			this.button_random.Margin = new System.Windows.Forms.Padding(4);
			...
			this.pictureBox_meme.Margin = new System.Windows.Forms.Padding(4);
			...
			this.tableLayoutPanel_img.PerformLayout();
			this.tabPage_font_style.ResumeLayout(false);
			this.tableLayoutPanel3.ResumeLayout(false);
			this.tableLayoutPanel3.PerformLayout();
			this.tabPage_sentences.ResumeLayout(false);
			this.tableLayoutPanel_sentence.ResumeLayout(false);
			this.tableLayoutPanel_sentence.PerformLayout();
		...
		private System.Windows.Forms.TabPage tabPage_font_style;
		private System.Windows.Forms.TabPage tabPage_sentences;
		...
		private System.Windows.Forms.RadioButton radioButton_Underline;
		private System.Windows.Forms.TableLayoutPanel tableLayoutPanel_sentence;
		private System.Windows.Forms.RadioButton radioButton_want_some;
